...
async def chat_about_summary(
    *,
    ...
    instructions = (
        ...
        "exactly 1–3 paragraphs of plain prose (purpose, process, outcome). "
        "No headings, bullet lists, or tables. Do not duplicate anomalies or detail notes. "
        "Do not mention REC- session ids, VoiceMeeter, backend STT, or other capture/tooling setup. "
